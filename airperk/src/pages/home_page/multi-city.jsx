...
function Multi_city() {
    ...
    const addCity = () => {
        setValue(
            () => {
                return (
                    <form action="" className="p-3 pt-0 input-group  " >
                        ...
                        <div className="form-control p-0 mb-3 rounded-end ">
                            <div className="form-floating">
                                <input type="text" readOnly className="form-control px-4 border border-0" id="floatingInput" placeholder="name@example.com" />
        ...
        console.log(moreCity.current.innerHTML);
        ...
        <>
            <section style={{ fontFamily: "'Montserrat', sans-serif" }}>
                ...
                <form action="" className="p-3 pt-0 input-group  " >
                    ...
                    <div className="form-control p-0 mb-3 border-0 border-start ">
                        <button type="button" onClick={addCity} className="d-flex gap-2 align-items-center justify-content-center text-primary w-100 h-100 border-0" style={{ backgroundColor: "transparent" }}>
                            <PlusOutlined className="fs-4 fw-bold" />
